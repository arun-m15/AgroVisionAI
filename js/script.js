...
const API_KEY = "AIzaSyBW3wpHQD-KLrKn9xrcN2tSmCZuRQ1uEI4"; // <-- Replace this
...
// Refresh/Delete Chat Button
const deleteBtn = document.getElementById("delete-chat-button");

deleteBtn.addEventListener("click", () => {
  if (confirm("Are you sure you want to clear and refresh the chat?")) {
